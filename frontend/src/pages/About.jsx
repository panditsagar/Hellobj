...
const About = () => {
  return (
    <section className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-gray-50 py-20 px-6">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <img
            src="/logo.svg"
            alt="About HelloBj"
            className="w-full max-w-sm mx-auto rounded-lg  hover:shadow-lg transition-shadow duration-300"
          />
          <div>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-3 text-base md:text-lg">
              {[
        ...
        {/* Vision and Values */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-10 tracking-wide">
            Our Vision & Values
          </h2>
        ...
        {/* Call to Action */}
        <div className="bg-blue-700 rounded-lg py-10 px-8 text-center text-white max-w-2xl mx-auto shadow-md">
          <h2 className="text-3xl font-bold mb-5">Ready to Elevate Your Business?</h2>
          <p className="text-base mb-7 leading-relaxed">
            Connect with us today and let’s start building your future-proof digital solution.
          </p>
          <Link
            to="/contact"
            className="inline-block bg-white text-blue-700 font-semibold rounded-full px-8 py-3 hover:bg-gray-100 transition duration-300 shadow-sm hover:shadow-md"
          >
            Contact Us
          </Link>
        </div>
